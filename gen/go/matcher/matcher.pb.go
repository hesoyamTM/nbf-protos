...
func (x *KickGroupRequest) GetOwnerId() string {
	if x != nil {
		return x.OwnerId
	}
	return ""
...
func (x *KickGroupRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
const file_matcher_matcher_proto_rawDesc = "" +
	...
	"\tKickGroup\x12\x19.matcher.KickGroupRequest\x1a\x16.google.protobuf.Empty\x124\n" +
...
var file_matcher_matcher_proto_depIdxs = []int32{
	...
	14, // 20: matcher.GroupQueryService.LeaveGroup:input_type -> matcher.LeaveGroupRequest
	13, // 21: matcher.GroupQueryService.KickGroup:input_type -> matcher.KickGroupRequest
	15, // 22: matcher.GroupQueryService.GetGroup:input_type -> matcher.GetGroupRequest
	10, // 23: matcher.GroupQueryService.GetGroupByUser:input_type -> matcher.GetGroupByUserRequest
	16, // 24: matcher.GroupQueryService.DeleteGroup:input_type -> matcher.DeleteGroupRequest
